        ...
        <KeyboardAwareScrollView keyboardShouldPersistTaps={'handled'}>
            <View style={styles.container}>
                ...
                {showOrButton && <View style={styles.socialButtons}>
                    {googleSignIn && <GoogleSignInButton title={'Sign up with Google'}/>}
                    {facebookSignIn && <View><FacebookSignInButton title={'Sign up with Facebook'}/></View>}
                    {appleSignIn &&
                        <View><AppleSignInButton buttonType={AppleAuthenticationButtonType.SIGN_UP}/></View>}
                    {anonymousSignIn && (<GuestSignInButton title={'Sign up as guest'}/>)}
                </View>}
                <BFText>
